...
describe('Register Test', function () {
    ...
    it(General_1.General.printBox('TC001-01 - Verify that user cannot register account with special character in username'), () => __awaiter(this, void 0, void 0, function* () {
        ...
        expect(yield registerPage.elementOfUsernameFieldErrorDisplay()).toBe(true, "username box didnot show error");
    }));
});
//# sourceMappingURL=register-TC001-01.js.map