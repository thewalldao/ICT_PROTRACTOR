...
describe('Register Test', function () {
    ...
    it(General_1.General.printBox('TC001-02 - Verify that user cannot register account without any lower character in password'), () => __awaiter(this, void 0, void 0, function* () {
        let username = General_1.General.makeUserName(7);
        let password = General_1.General.makeRandomChar(true, false, true, true) + General_1.General.randomNumberCharString(5);
        ...
        expect(yield registerPage.passwordNotIncludeLowerCharErrorDisplay()).toEqual("contains at least one lower character", "error message is not match");
    }));
});
//# sourceMappingURL=register-TC001-02.js.map