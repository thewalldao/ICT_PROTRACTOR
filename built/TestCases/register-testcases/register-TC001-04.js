...
describe('Register Test', function () {
    ...
    it(General_1.General.printBox('TC001-04 - Verify that user cannot register account without any digit character in password'), () => __awaiter(this, void 0, void 0, function* () {
        let username = General_1.General.makeUserName(7);
        let password = General_1.General.makeRandomChar(true, true, false, true) + General_1.General.randomLowerCharString(5);
        ...
        expect(yield registerPage.passwordNotIncludeDigitCharErrorDisplay()).toEqual("contains at least one digit character", "error message is not match");
    }));
});
//# sourceMappingURL=register-TC001-04.js.map