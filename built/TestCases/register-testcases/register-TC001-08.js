...
describe('Register Test', function () {
    ...
    it(General_1.General.printBox('TC001-08 - Verify that user cannot register account with blank email address'), () => __awaiter(this, void 0, void 0, function* () {
        ...
        expect(yield registerPage.elementOfEmailFieldErrorDisplay()).toBe(true, "Email box did not show error");
    }));
});
//# sourceMappingURL=register-TC001-08.js.map