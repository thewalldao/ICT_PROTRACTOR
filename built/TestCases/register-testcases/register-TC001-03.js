...
describe('Register Test', function () {
    ...
    it(General_1.General.printBox('TC001-03 - Verify that user cannot register account without any upper character in password'), () => __awaiter(this, void 0, void 0, function* () {
        let username = General_1.General.makeUserName(7);
        let password = General_1.General.makeRandomChar(false, true, true, true) + General_1.General.randomNumberCharString(5);
        ...
        expect(yield registerPage.passwordNotIncludeUpperCharErrorDisplay()).toEqual("contains at least one upper character", "error message is not match");
    }));
});
//# sourceMappingURL=register-TC001-03.js.map